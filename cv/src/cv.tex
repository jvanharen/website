...
\begin{tabular}{l}
    ...
    % \textsc{AIRBUS} Operations \textsc{S.A.S.}                                     \\
    % PO Box M0112/4                                                                 \\
    % 316 route de Bayonne                                                           \\
    % 31060 Toulouse CEDEX 09, France                                                \\
    % \ding{37} +33 (0) 5 61 93 67 86                                                \\
    % \ding{41} \href{mailto:alois.sengissen@airbus.com}{alois.sengissen@airbus.com} \\
    \\
    Dr. Xavier Vasseur                                                           \\
